...
void pcm_th(float x[], int length_x, float sigma, float thr_const = 1, int s = 1, int e, int points = 3, int k_l = 1, int k_r = 1, int cpt[]) {
	...
	if (e - s <= 1) chp = 0;
		...
		s_e_points(r_e_points, l_e_points, s, e, length_x, right_points, rur, left_points, lur);
